...
class DataWorker(Worker):
    ...
    def run(self):
        ...
        envs = make_envs(config.env.env, config.env.game, num_envs, cur_seed + self.rank * num_envs,
                         ...
                         num_slots = config.oc.n_slots, slot_dim = config.oc.slot_dim,
                         ocr_config_path=config.oc.ocr_config_path,
                         checkpoint_path=config.oc.checkpoint_path,
                ...
                if dones[i]:
                    ...
                    if self.config.env.env == 'DMC':
                        envs[i] = make_env(config.env.env, config.env.game, num_envs, cur_seed + self.rank * num_envs,
                             ...
                             num_slots = config.oc.n_slots, slot_dim = config.oc.slot_dim,
                             ocr_config_path=config.oc.ocr_config_path,
                             checkpoint_path=config.oc.checkpoint_path, **config.env)
